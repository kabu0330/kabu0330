...
현재는 Unity Engine으로 Android AppStore 출시를 목표로 개발을 진행 중입니다. 어쩌면 저의 마지막 게임 프로젝트일지도 몰라 소중히 만들고 있습니다.
...
그럼에도 초기 학습 단계에서는 다음과 같은 이점 때문에 `Tick` 기반 방식을 선호했습니다.
...
1. Lambda: 게임 로직의 중추 신경망 (Node.js)
